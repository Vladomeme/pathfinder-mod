...
//todo teleporter type (two-way, exit, entrance)
...
public class LocationData {
    ...
    private LocationData(long id, boolean isTeleport, String name, int[] area) {
        this.id = id;
    ...
    public LocationData copy() {
        return new LocationData(this.id, this.isTeleport, this.name, Arrays.copyOf(this.area, this.area.length));
    }
    ...
    public boolean matchesDefault() {
        return (!isTeleport && (name == null || name.isEmpty())
